...
export default function Navbar({ theme, setTheme }) {
 ...
 const navActive = () => {
  document
   ...
   .classList.add("bg-slate-100", "dark:bg-gray-800", "shadow-md");
 ...
 const navInactive = () => {
  ...
  document
   .getElementById("navbar")
   .classList.remove("bg-slate-100", "dark:bg-gray-800", "shadow-md");
 };
 ...
 return (
  <>
   <nav
    className="bg-transparent pb-4 pt-5 sticky top-0 z-50 transition-all duration-300"
    id="navbar"
   >
    ...
    <div className="lg:hidden" id="mobile-menu" hidden={openNav == false}>
     ...
     <div className="dark:text-white space-y-1 px-2 flex items-center justify-between">
      ...
      >
       <button className="hover:bg-gray-300 rounded-full p-2 text-sm font-medium dark:hover:bg-gray-600">
        {theme === "dark" ? (
         <>
          <svg
           xmlns="http://www.w3.org/2000/svg"
