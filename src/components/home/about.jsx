...
function About() {
    ...
    return (
        <>
            ...
            <div className="mt-8 my-14 py-4 rounded-lg bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 shadow-md dark:shadow-xl">
                <div id="section1" className="_section">
                    {
                        Data.about.experience.map((e, i) => (
                            <div key={i} className="relative">
                                <div className="md:ms-14 md:me-7 py-5 px-7 md:p-5">
                                    <span>
                                        <img src={e.logo} alt="Experience" className="md:absolute flex items-center justify-center w-16 h-16 bg-blue-100 rounded-full -start-8 md:ring-8 md:ring-white md:dark:ring-gray-900 dark:bg-blue-900 mb-4 md:mb-0" />
                                    </span>
                                    <h3 className="flex items-center mb-1 text-xl md:text-2xl whitespace-nowrap font-semibold text-gray-900 dark:text-white">{e.company} <span className="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3">{e.position}</span></h3>
                                    <p className="mb-4 mt-3 font-normal text-gray-500 dark:text-white">{e.description}</p>
                                ...
                                {(i + 1) !== Data.about.experience.length && <div className="mx-auto line-through w-0.5 h-16 border-r-2 border-dashed border-gray-200 dark:border-slate-700"
                                ></div>}
                            </div>
                        ))
                    }
