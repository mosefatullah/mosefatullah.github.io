        ...
        <div className="__about min-h-[70vh]">
            <Helmet>
                ...
                <meta
                    ...
                    data-react-helmet="true"
                />
                <link rel="canonical" href="https://mosefatullah.github.io/contact" data-react-helmet="true" />
            ...
            >
                <section className="bg-white dark:bg-gray-800 p-8 lg:py-14 lg:px-12 rounded max-w-[500px] mx-auto lg:mx-0">
                    <h2 className="mb-4 text-4xl tracking-tight font-bold text-center text-gray-900 dark:text-white">Contact</h2>
                    <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-lg">If you want to contact him, please fill up this form:</p>
                    <form action="#" className="space-y-8">
                        ...
                        <div>
                            ...
                            <input type="text" id="subject" className="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="eg. Services" required />
                        </div>
                ...
                <section className="p-8 lg:px-12">
                    <h2 className="mb-8 text-4xl tracking-tight font-bold text-center text-gray-900 dark:text-white">Schedule Meeting</h2>
                    <div className="calendly-inline-widget" data-url="https://calendly.com/mosefatullah?hide_gdpr_banner=1" style={{ minWidth: "400px", height: "400px" }}></div>
                </section>
            </div>
        </div>
    );
