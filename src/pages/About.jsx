    ...
    >
     <div className="max-w-xl lg:mb-0">
      ...
      <p className="mt-9 text-gray-600 dark:text-gray-400">
       ...
       programmer, hails from the Barishal District of Bangladesh. Born on 2006,
       his passion for coding ignited while he was still in seventh grade. This
       early spark ignited a dream – to become a software engineer and make a
     ...
     <div className="max-w-xl mb-[5rem] lg:mb-0">
      <p className="text-gray-600 dark:text-gray-400">
       ...
       (religious school). He is currently furthering his studies at Tamirul
       Millat Kamil Madrasah (religious high school). Despite his academic
       commitments, his dedication to coding hasn't wavered. He actively
       volunteers with an organization, contributing his coding skills to
       ongoing projects. This experience not only hones his technical abilities
       but also allows him to give back to his community in a meaningful way.
      </p>
     </div>
    </div>
   </div>
