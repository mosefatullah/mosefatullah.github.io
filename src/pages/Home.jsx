 ...
 return (
  <>
   ...
   <motion.div
    ...
    animate={{ rotate: 360, opacity: 0 }}
    className="_sketch absolute top-[80vh] right-10 opacity-50 hidden lg:block"
   >
    <svg
     fill="none"
     height="44"
   ...
   <div className="__home" ref={homeRef}>
      ...
      >
       ...
       <div className="bg-gray-700 border-b border-gray-600 whitespace-nowrap overflow-x-auto">
        <button className="bg-gray-800 px-3 py-1 border-e border-gray-600">
         <span className="px-1 bg-orange-500 text-black rounded-sm font-bold text-sm me-1">
          5
         </span>{" "}
         <span className="text-sm text-gray-400">index.html</span>
        </button>
        <button className="px-3 py-1 border-e border-gray-600">
         <span className="px-0.5 bg-yellow-500 text-black rounded-sm font-bold text-sm me-1">
          JS
         </span>{" "}
         <span className="text-sm text-gray-400">app.js</span>
        </button>
        <button className="px-3 py-1 border-e border-gray-600">
         <span className="px-1 bg-[#42a5f5] text-black rounded-sm font-bold text-sm me-1">
          3
         </span>{" "}
         <span className="text-sm text-gray-400">style.css</span>
        </button>
       </div>
       <div className="px-5 py-4 text-white whitespace-nowrap overflow-x-auto">
        <p>
         <span className="text-gray-400 inline-block w-[20px] border-r border-gray-400 mr-5">
          1
         </span>
       ...
       <div className="border-t border-gray-600 flex bg-blue-500 rounded-b-lg text-white whitespace-nowrap overflow-x-auto">
        <button className="py-0.5 px-2.5 bg-green-700 rounded-bl-lg text-sm font-semibold">
         &gt;<sup className="inline-block -ml-0.5 scale-[1.3]">&lt;</sup>
        </button>
    ...
    <div className="w-full border-t border-gray-200 dark:border-0 bg-pattern dark:bg-dpattern lg:py-5 dark:from-gray-900 bg-gradient-to-r from-white">
     ...
     <WithMotion
      ...
      className="__overview-section w-full mx-auto p-4 md:px-8 py-14 max-w-7xl"
      id="overview"
     >
